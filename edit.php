                ...
                <div class="p-4 m-2 bg-neutral-950 rounded-2xl justify-items-center">
                    <form method="POST" action="controller.php" class="justify-items-center">
                        <div class="form-row">
                            ...
                            <input class="text-white bg-neutral-800" type="text" name="model" value="<?=$mobil->model?>"><br>
                        </div>
                        <div class="form-row justify-items-center">
                            ...
                            <input class="cursor-pointer bg-neutral-800 text-white p-2 rounded-2xl text-xs" type="file"
                                id="img" name="img" accept="image?*" value="<?=$mobil->gambar?>"><br>
                        </div>
                        <div class="form-row">
                            <label class="text-white font-bold" for="kategori">Kategori:</label><br>
                            <input class="text-white bg-neutral-800" type="text" name="kategori" value="<?=$mobil->kategori?>"><br>
                        </div>
                        <div class="form-row">
                            <label class="text-white font-bold" for="model">Merek:</label><br>
                            <input class="text-white bg-neutral-800" type="text" name="merek" value="<?=$mobil->merek?>"><br>
                        </div>
                        <div class="form-row">
                            <label class="text-white font-bold" for="kategori">Negara:</label><br>
                            <input class="text-white bg-neutral-800" type="text" name="negara" value="<?=$mobil->negara?>"><br>
                        </div>
                        <div class="form-row">
                            <label class="text-white font-bold" for="kategori">Tahun:</label><br>
                            <input class="text-white bg-neutral-800" type="text" name="tahun" value="<?=$mobil->tahun?>"><br>
                        </div>
                        <div class="form-row">
                            <input type="hidden" name="inputID"value="<?=$IDMobil?>">
                            <button name="edit"
